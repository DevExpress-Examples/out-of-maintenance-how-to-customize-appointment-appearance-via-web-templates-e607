...
{************************************************************************************}
--%>
<%@ Control Language="vb" AutoEventWireup="true" CodeFile="VerticalAppointmentTemplate.ascx.vb" Inherits="VerticalAppointmentTemplate" %>
							...
							<table width="100%" cellpadding="1" cellspacing="0" >                        
								<tr>
									<td>
										...
										<dxe:ASPxLabel runat="server" EnableViewState="false" EncodeHtml="true" ID="lblEndTime" Text='<%#(CType(Container, VerticalAppointmentTemplateContainer)).Items.EndTimeText.Text%>' Visible='<%#(CType(Container, VerticalAppointmentTemplateContainer)).Items.EndTimeText.Visible%>'></dxe:ASPxLabel>        
