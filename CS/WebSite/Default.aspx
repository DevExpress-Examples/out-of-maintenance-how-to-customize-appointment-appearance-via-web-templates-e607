...
<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v8.1, Version=8.1.8.0, Culture=neutral, PublicKeyToken=9b171c9fd64da1d1"
    Namespace="DevExpress.Web.ASPxScheduler" TagPrefix="dxwschs" %>
<%@ Register Assembly="DevExpress.XtraScheduler.v8.1.Core, Version=8.1.8.0, Culture=neutral, PublicKeyToken=9b171c9fd64da1d1"
    Namespace="DevExpress.XtraScheduler" TagPrefix="cc1" %>
<%@ Register Src="~/CustomForms/MyVerticalAppointment.ascx" TagName="VerticalAppointment" TagPrefix="va" %>
...
<body>
    ...
    <div>
        ...
        <dxwschs:ASPxScheduler ID="ASPxScheduler1" runat="server" AppointmentDataSourceID="CarsSchedulingDataSource"
            ResourceDataSourceID="CarsDataSource" OnAppointmentRowInserted="ASPxScheduler1_AppointmentRowInserted" OnAppointmentRowInserting="ASPxScheduler1_AppointmentRowInserting" OnAppointmentsInserted="ASPxScheduler1_AppointmentsInserted" OnAppointmentFormShowing="ASPxScheduler1_AppointmentFormShowing" OnBeforeExecuteCallbackCommand="ASPxScheduler1_BeforeExecuteCallbackCommand" Width="400px" Start="2008-03-13">
         <OptionsForms AppointmentFormTemplateUrl="~/CustomForms/MyAppointmentForm.ascx" />
            <Storage>
